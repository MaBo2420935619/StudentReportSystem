...
public class Controller {
    ...
    public JSONObject getControllerMap(String message){
        try {
...
//                log.info("parames:"+pathAndParam[1]);
                String parame[]=null;
...
//                        log.info("获取到的参数"+datas[0]+":"+datas[1]);
                    }
                }
                try {
                    for (String a: parame) {
...
//                            log.info("获取到的参数"+datas[0]+":"+datas[1]);
            ...
            Object o = ExcuteMethodUtil.excuteMethod(path, map);
    ...
    public void receiveHttpRequestController( Socket socket ){
        ...
        //开始接收请求并且处理
        JSONObject json = controller.getControllerMap(result);
        //业务处理结束，返回数据
